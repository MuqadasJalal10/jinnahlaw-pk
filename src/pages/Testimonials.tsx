...
const students = [
  { name: 'Muhammad Azhar', program: '73/100', text: 'Scored an impressive 73 through dedication and guidance from expert faculty.', image: '' },
  { name: 'Awais Ahmad', program: '66/100', text: 'Consistent effort and structured preparation helped secure 66 marks.', image: '' },
  { name: 'M. Abubakar', program: '59/100', text: 'Strong foundation in concepts led to a solid score of 59.', image: '' },
  ...
  { name: 'Junaid Mohsin', program: '57/100', text: 'Focused practice sessions and test simulations helped me achieve 57 marks.', image: '' },
  ...
  { name: 'Sobai Hafeez', program: '66/100', text: 'Proud to have achieved 66 marks with the help of mock tests and materials.', image: '' },
  { name: 'Hajra Asif', program: '65/100', text: 'With discipline and academy support, I successfully scored 65.', image: '' },
  { name: 'Ayesha Yaqoob', program: '56/100', text: 'Happy to be part of the academy – scored 56 successfully.', image: '' },
];
